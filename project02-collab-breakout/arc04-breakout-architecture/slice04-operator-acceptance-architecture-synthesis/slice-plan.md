...
`artifacts/operator-accepted-architecture.md`. The accepted architecture
incorporates operator adjustments to component names, component placement,
agent coordination, component maintenance/version history, ontology critique
placement, and memory-admission deferral.

CDC has verified the Slice04 packet. Arc04 is ready for formal arc close.
