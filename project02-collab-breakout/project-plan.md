...
the architecture decision instrument and is verified/closed. Slice 02 is open
to evaluate candidate component contracts.
...
verified/closed, and Slice 03 can open for target composition and package
architecture.
