...
**Status:** Draft v0.2 — review iterations through v0.2e incorporated. Not yet implementation-ready; see spec-quality next steps below.
...
- `review-v0.2e/` — fifth unreleased-v0.2 review (7 files, current)
