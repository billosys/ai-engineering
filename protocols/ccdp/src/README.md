...
**Status:** Draft v0.2 — third review round incorporated. Not yet implementation-ready; see spec-quality next steps below.
...
- `review-v0.2b/` — second unreleased-v0.2 review (25 files, current)
