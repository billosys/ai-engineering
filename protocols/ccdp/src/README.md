...
**Status:** Draft v0.2 — review iterations through v0.2g incorporated. Not yet implementation-ready; see spec-quality next steps below.
...
- `review-v0.2g/` — seventh unreleased-v0.2 review (7 files, current)
