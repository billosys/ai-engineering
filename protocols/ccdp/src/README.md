...
**Status:** Draft v0.2 — review iterations through v0.2h incorporated. Not yet implementation-ready; see spec-quality next steps below.
...
- `review-v0.2h/` — eighth unreleased-v0.2 review (6 files, current)
