...
**Status:** Draft v0.2 — review iterations through v0.2f incorporated. Not yet implementation-ready; see spec-quality next steps below.
...
- `review-v0.2f/` — sixth unreleased-v0.2 review (11 files, current)
