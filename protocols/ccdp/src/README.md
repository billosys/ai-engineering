...
**Status:** Draft v0.2 — fourth review round incorporated. Not yet implementation-ready; see spec-quality next steps below.
...
- `review-v0.2c/` — third unreleased-v0.2 review (26 files, current)
