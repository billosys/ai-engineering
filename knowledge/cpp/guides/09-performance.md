...
- `s-performance` — Per: Performance (source lines 13847-14288)

## Rule Index

- `Per.1` — Don't optimize without reason (`rper-reason`, source line 13877)
- `Per.2` — Don't optimize prematurely (`rper-knuth`, source line 13889)
- `Per.3` — Don't optimize something that's not performance critical (`rper-critical`, source line 13897)
- `Per.4` — Don't assume that complicated code is necessarily faster than simple code (`rper-simple`, source line 13913)
- `Per.5` — Don't assume that low-level code is necessarily faster than high-level code (`rper-low`, source line 13945)
- `Per.6` — Don't make claims about performance without measurements (`rper-measure`, source line 13957)
- `Per.7` — Design to enable optimization (`rper-efficiency`, source line 13977)
- `Per.10` — Rely on the static type system (`rper-type`, source line 14142)
- `Per.11` — Move computation from run time to compile time (`rper-comp`, source line 14150)
- `Per.12` — Eliminate redundant aliases (`rper-alias`, source line 14229)
- `Per.13` — Eliminate redundant indirections (`rper-indirect`, source line 14233)
- `Per.14` — Minimize the number of allocations and deallocations (`rper-alloc`, source line 14237)
- `Per.15` — Do not allocate on a critical branch (`rper-alloc0`, source line 14241)
- `Per.16` — Use compact data structures (`rper-compact`, source line 14245)
- `Per.17` — Declare the most used member of a time-critical struct first (`rper-struct`, source line 14253)
- `Per.18` — Space is time (`rper-space`, source line 14257)
- `Per.19` — Access memory predictably (`rper-access`, source line 14265)
- `Per.30` — Avoid context switches on the critical path (`rper-context`, source line 14285)
