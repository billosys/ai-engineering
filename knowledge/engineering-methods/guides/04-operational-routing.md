...
| Author or review an initial or corrective CC implementation prompt | [From Slice to Implementation Prompt](./07-implementation-prompt-authoring.md) | Relevant domain guides, actual source and tests, then the [authoring template](../templates/cc-implementation-prompt.md). |
