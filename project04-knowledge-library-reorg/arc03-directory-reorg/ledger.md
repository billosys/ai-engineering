...
| A-3 | Mechanical source moves close with accepted knowledge roots, source-prose preservation, and package behavior preserved | `rg -n "verified-closed|mechanical move|knowledge/collaboration-framework|knowledge/<component>|concept-card-method|templates|source-prose preservation|package behavior" slice03-*/*verification.md slice04-*/*verification.md` | serious | arc-plan | open | Partial: Slice03 `cdc-verification.md` records `verified-closed`, mechanical move, `knowledge/collaboration-framework`, templates, source-prose preservation, and package behavior. Slice04 remains required for `knowledge/<component>` and `concept-card-method` accounting. | Child-slice closure evidence for move slices. |
...
Arc remains open. Slice01, Slice02, and Slice03 are verified-closed; Slice04 is
open.

Rows: 6. Done: 2. Deferred: 0. No-op: 0.
