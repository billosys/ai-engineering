...
| A-5 | Arc07 composition demonstrates accepted knowledge component entrypoints and guide layout without path/package ambiguity | `test -f closing-report.md && rg -n "Composition verdict: delivered|component entrypoint|SKILL.md|guides|docs/ holdover|package|install|reconciled" closing-report.md` | serious | arc-plan | open | | Reproduce at arc close. |

## Closure

Arc is open pending operator review. Slice01 through Slice04 are
verified-closed; formal Arc07 close has not been performed.

Rows: 5. Done: 4. Deferred: 0. No-op: 0.
