...
| --- | --- | --- | --- | --- | --- | --- | --- |
| S7-1 | Exact inspected definitions and data have registered identities and roles | Resolve sections, hashes and historical/current context | correctness-grade | S4-1 | done (CC attested) | artifacts/semantic-evidence.md | Iteration 01 adds frozen census and locator comparison contexts; CDC pending |
...
| S7-3 | Legacy attribution and location meanings retain source-specific values, shapes and limitations | Replay scoped census; inspect named bodies and source-family differences | serious | S4-3/S4-5 | done (CC attested) | artifacts/semantic-evidence.md | Music/Erlang shapes and attribution/location distinctions recorded; CDC pending |
| S7-4 | Current locator meanings preserve identity, basis and mapping boundaries | Review thirteen fields against guidance, examples and available actual locators | serious | S4-3 | done (CC attested) | artifacts/semantic-evidence.md | PDF/anchor/line/map distinctions added; CDC pending |
| S7-5 | Every membership has supported dispositions and useful old/current consequences | Resolve both evidence layers; inspect query/body/preservation differences | serious | S4-3/S4-5 | done (CC attested) | artifacts/semantic-evidence.md; artifacts/semantic-membership.json | Field-specific consequences recorded; CDC pending |
| S7-6 | Complete literal replay and handoff preserve all remaining obligations | Run recorded commands and seven-row walk; check 47/20/488 accounting | correctness-grade | S4-6/S4-7 | done (CC attested) | artifacts/validation-evidence.md; artifacts/handoff.md; closing-report.md | Expanded replay/row walk/handoff; CDC pending |
