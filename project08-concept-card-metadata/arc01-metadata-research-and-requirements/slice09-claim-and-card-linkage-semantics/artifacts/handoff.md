...
Architecture work needs explicit decisions on whether embedded claim and
support targets are formal records, how literal fragments are represented and
validated, when reciprocal card/claim links are required, and how a target
revision applies to an embedded section. It must retain legacy scalar snapshots
without confusing them with structured source tuples, and retain assertion-
