...
| --- | --- | --- | --- | --- | --- | --- | --- |
| A1-1 | Historical and live inventories are reproducible and complete within declared corpus availability | Independently check Slice01 artifacts and commands plus Slice04/05/06 remediation composition | correctness-grade | P-1 | open | Slice01 artifacts/remediation-decomposition.md plus arc-plan.md; Slice04 CDC Batch01 acceptance | Ten-pair checkpoint accepted; Slice06 and all remaining contextual work still required; no closure from the split |
