...
The committed wrapper and endpoint commit IDs are recorded in the validation
artifact after the CC endpoint is created. A same-revision invocation and a
separate CC/recipe invocation are required; missing and foreign recipe
endpoints must fail closed. CRC remains responsible for independent
reproduction and CDC remains responsible for composition.
