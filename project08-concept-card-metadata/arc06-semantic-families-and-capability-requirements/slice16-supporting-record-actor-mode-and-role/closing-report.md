...
with status 2. A separate CC/recipe invocation will be recorded after this
record update; CRC remains responsible for independent reproduction and CDC
remains responsible for composition.
