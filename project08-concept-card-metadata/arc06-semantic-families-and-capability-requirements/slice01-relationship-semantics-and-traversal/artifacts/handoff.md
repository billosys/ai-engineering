...
CC proposes 35 relationship meanings only; CDC has not accepted them. Preserve
legacy typed-assertion orientation, the historical common-confusion meaning of
`contrasts_with`, and edge-support distinctions. Predicate naming, target
anchors, revisions and reciprocal storage remain architecture questions.
...
support-path components. Concrete research questions are: what resolves the
...
assertion becomes an independently tracked edge.
