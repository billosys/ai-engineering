...
Reference implementation for the PDF-prep prompt (docs/dev/concept-cards/0005-*-v2.md).
When adapting for a new source, update `MD_DIR` to
`knowledge/<kb>/sources/md/<source-slug>/` and adjust the regex if the converter
emitted a different image-reference pattern.
"""
...
# Path is relative to the project root — run this script from there.
MD_DIR = Path("knowledge/music-theory/sources/md/neo-riemannian-handbook")
