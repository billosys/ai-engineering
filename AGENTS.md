...
- **Project ordering:** as of 2026-08-29, `project01-harmonise-paths` is the
  ...
  the plan.
- **Project01 status:** Arc 01 is closed. Arc 02 is active; Slice 01 and Slice
  02 are verified/closed, and Slice 03 is opened for mature language
  entrypoint staging transforms.
