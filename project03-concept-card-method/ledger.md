...
|----|-----------|--------|--------------|--------|--------|----------|-------|
| P-1 | Arc 01 closes with a Project02 boundary aid accepted as input to Project02 Arc02 | `test -f arc01-method-positioning/closing-report.md && rg -n "Composition verdict: delivered|Project02 Arc02" arc01-method-positioning/closing-report.md` | serious | project-plan | open | | Soft dependency for Project02 Arc02. |
